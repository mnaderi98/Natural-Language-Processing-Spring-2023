...
def train(parser, train_data, dev_data, output_path, batch_size=1024, n_epochs=10, lr=0.0005):
    ...
    optimizer = optim.Adam([parser.model.embed_to_hidden_weight, parser.model.embed_to_hidden_bias, parser.model.hidden_to_logits_weight, parser.model.hidden_to_logits_bias])
