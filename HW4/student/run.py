...
def train(args: Dict):
    ...
    """
    train_data_src = read_corpus("./zh_en_data/train.zh", source='src', vocab_size=21000)       # EDIT: NEW VOCAB SIZE
    train_data_tgt = read_corpus("./zh_en_data/train.en", source='tgt', vocab_size=8000)

    dev_data_src = read_corpus("./zh_en_data/dev.zh", source='src', vocab_size=3000)
    dev_data_tgt = read_corpus("./zh_en_data/dev.en", source='tgt', vocab_size=2000)
